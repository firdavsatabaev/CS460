Important Note: instead of creating PassPhrase button, I included it as one of the options in the drop box where there different options (digits, lowercase, etc).
